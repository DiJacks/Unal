package com.bbagliotto.reto8.reto8;
...
public class ViewAllEnterprises extends ListActivity{
    ...
    private CheckBox filterConsuloria, filterDesarollo, filterFabricacion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filterDesarollo = (CheckBox) findViewById(R.id.check_box_desarollo);
    ...
    public void onCheckboxClicked(View view) {
        ...
        switch(view.getId()) {
            case R.id.check_box_consultoria:
                ...
                // Remove the meat
                break;
            case R.id.check_box_desarollo:
                if (checked)
                    (ViewAllEnterprises.this).adapter.getFilter().filter("desarollo");
                else
                    (ViewAllEnterprises.this).adapter.getFilter().filter("");
                break;
